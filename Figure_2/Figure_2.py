...
sopc_r1= pd.read_csv('data_Figure_2/ST_0/SOPC/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
sopc_r2= pd.read_csv('data_Figure_2/ST_0/SOPC/replica_2/Deer_analysis2us', delim_whitespace=True)
...
st5_r1= pd.read_csv('data_Figure_2/ST_5/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
st5_r2= pd.read_csv('data_Figure_2/ST_5/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
st10_r1= pd.read_csv('data_Figure_2/ST_10/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
st10_r2= pd.read_csv('data_Figure_2/ST_10/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
st15_r1= pd.read_csv('data_Figure_2/ST_15/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
st15_r2= pd.read_csv('data_Figure_2/ST_15/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
st20_r1=pd.read_csv('data_Figure_2/ST_20/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
st20_r2= pd.read_csv('data_Figure_2/ST_20/replica_2/Deer_analysis_part2', delim_whitespace=True)
...
##ICL2
st5_ssr1=pd.read_csv('data_Figure_2/ST_5/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
st5_ssr1.columns=['time', 'structure', 'coil', 'B_bridge','Bend', 'Turn', 'A_Helix','Th_Helix']
st5_ssr1=st5_ssr1[-40000:]

st5_ssr2=pd.read_csv('data_Figure_2/ST_5/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
st5_ss=pd.concat([st5_ssr1, st5_ssr2], axis=1)
st5_ss_err=pd.concat([st5_ssr1, st5_ssr2], axis=1).mean(axis=1).std()

st10_ssr1=pd.read_csv('data_Figure_2/ST_10/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
st10_ssr1.columns=['time', 'structure', 'coil','Bend', 'Turn', 'A_Helix','Fiv_Helix','Th_Helix']
st10_ssr1=st10_ssr1[-40000:]

st10_ssr2=pd.read_csv('data_Figure_2/ST_10/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
st15_ssr1=pd.read_csv('data_Figure_2/ST_15/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
st15_ssr1.columns=['time', 'structure', 'coil','Bend', 'Turn', 'A_Helix','Fiv_Helix','Th_Helix']
st15_ssr1=st15_ssr1[-40000:]

st15_ssr2=pd.read_csv('data_Figure_2/ST_15/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
st15_ss=pd.concat([st15_ssr1, st15_ssr2], axis=1)
st15_ss_err=pd.concat([st15_ssr1, st15_ssr2], axis=1).mean(axis=1).std()


st20_ssr1=pd.read_csv('data_Figure_2/ST_20/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
st20_ssr1.columns=['time', 'structure', 'coil','B-bridge','Bend', 'Turn', 'A_Helix','Th_Helix']
st20_ssr1=st20_ssr1[-40000:]

#st20_ssr2=pd.read_csv('data/ST_20/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
#st20_ssr2.columns=['time', 'structure', 'coil','B-bridge','Bend', 'Turn', 'A_Helix','Th_Helix']
#st20_ssr2=st20_ssr2[-40000:]


st20_ssr1=st20_ssr1[['A_Helix','Th_Helix']].sum(axis=1)
#st20_ssr2=st20_ssr2[['A_Helix','Th_Helix']].sum(axis=1)
st20_ss=st20_ssr1
#st20_ss_err=pd.concat([st20_ssr1, st20_ssr2], axis=1).mean(axis=1).std()
...
sopc_ssr1=pd.read_csv('data_Figure_2/ST_0/SOPC/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
sopc_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Fiv_Helix','Th_Helix']

sopc_ssr2=pd.read_csv('data_Figure_2/ST_0/SOPC/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
box_parts = ax.boxplot((sopc[['TM1-TM6']][180000:].dropna().to_numpy().flatten()*10,
                              st5[['TM1-TM6']].dropna().to_numpy().flatten()*10,
                              st10[['TM1-TM6']].dropna().to_numpy().flatten()*10,
                              st15[['TM1-TM6']].dropna().to_numpy().flatten()*10,
                              st20[['TM1-TM6']].dropna().to_numpy().flatten()*10), vert=True, positions=(0,5,10,15,20), widths=[width,width,width,width,width],
                              medianprops=dict(color='darkred'), showfliers=False, patch_artist=True)
...
box_parts = ax1.boxplot((sopc[['TM1-ICL2']][180000:].dropna().to_numpy().flatten()*10,
                              st5[['TM1-ICL2']].dropna().to_numpy().flatten()*10,
                              st10[['TM1-ICL2']].dropna().to_numpy().flatten()*10,
                              st15[['TM1-ICL2']].dropna().to_numpy().flatten()*10,
                              st20[['TM1-ICL2']].dropna().to_numpy().flatten()*10), vert=True, positions=(0,5,10,15,20), widths=[width,width,width,width,width],
                              medianprops=dict(color='darkred'), showfliers=False, patch_artist=True)
...
box_parts = ax2.boxplot((sopc[['TM5-ICL2']][180000:].dropna().to_numpy().flatten()*10,
                              st5[['TM5-ICL2']].dropna().to_numpy().flatten()*10,
                              st10[['TM5-ICL2']].dropna().to_numpy().flatten()*10,
                              st15[['TM5-ICL2']].dropna().to_numpy().flatten()*10,
                              st20[['TM5-ICL2']].dropna().to_numpy().flatten()*10), vert=True, positions=(0,5,10,15,20), widths=[width,width,width,width,width],
                              medianprops=dict(color='darkred'), showfliers=False, patch_artist=True)
...
box_parts = ax3.boxplot((sopc[['TM6-H8']][180000:].dropna().to_numpy().flatten()*10,
                              st5[['TM6-H8']].dropna().to_numpy().flatten()*10,
                              st10[['TM6-H8']].dropna().to_numpy().flatten()*10,
                              st15[['TM6-H8']].dropna().to_numpy().flatten()*10,
                              st20[['TM6-H8']].dropna().to_numpy().flatten()*10), vert=True, positions=(0,5,10,15,20), widths=[width,width,width,width,width],
                              medianprops=dict(color='darkred'), showfliers=False, patch_artist=True)
...
box_parts = ax7.boxplot((sopc[['TM3-TM6-ASP241']][180000:].dropna().to_numpy().flatten()*10,
                              st5[['TM3-TM6-ASP241']].dropna().to_numpy().flatten()*10,
                              st10[['TM3-TM6-ASP241']].dropna().to_numpy().flatten()*10,
                              st15[['TM3-TM6-ASP241']].dropna().to_numpy().flatten()*10,
                              st20[['TM3-TM6-ASP241']].dropna().to_numpy().flatten()*10), vert=True, positions=(0,5,10,15,20), widths=[width,width,width,width,width],
                              medianprops=dict(color='darkred'), showfliers=False, patch_artist=True)
...
box_parts = ax5.boxplot((sopc_ss.dropna().to_numpy().flatten(),
                               st5_ss.dropna().to_numpy().flatten(),
                               st10_ss.dropna().to_numpy().flatten(),
                               st15_ss.dropna().to_numpy().flatten(),
                               st20_ss.dropna().to_numpy().flatten()), vert=True, positions=(0,5,10,15,20), widths=[width,width,width,width,width],
                               medianprops=dict(color='darkred'), showfliers=False, patch_artist=True)
...
ax5.axhline(y=0.0, linestyle='--', lw=1.5, color='0.5')
#ax5.set_ylim(0,0.7)
...
fig = plt.gcf()
plt.subplots_adjust(top=0.92, bottom=0.115, left=0.07, right=0.98, hspace=0.43, wspace=0.4)
plt.Figure.set_size_inches(fig,(9, 4))
