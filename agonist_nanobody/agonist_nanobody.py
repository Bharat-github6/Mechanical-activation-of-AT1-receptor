...
plt.fill_between(time_ang,ang_ss.rolling(window).mean()-ang_ss_err.rolling(window).mean(),ang_ss.rolling(window).mean()+ang_ss_err.rolling(window).mean(), color='tab:blue', alpha=0.1)
...
plt.fill_between(time_a,s1i8_ss.rolling(window).mean()-s1i8_ss_err.rolling(window).mean(),s1i8_ss.rolling(window).mean()+s1i8_ss_err.rolling(window).mean(), color='tab:red', alpha=0.1)
