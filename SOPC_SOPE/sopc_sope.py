...
pepc_r1= pd.read_csv('data/PE_PC/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
pepc_r2= pd.read_csv('data/PE_PC/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
pepc_r1_1us= pd.read_csv('data/PE_PC/replica_1/ICL2_1us.xvg', delim_whitespace=True, comment='#')
pepc_r1_1us.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']

pepc_r1_2us= pd.read_csv('data/PE_PC/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
ss_pepc_r2= pd.read_csv('data/PE_PC/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
ss_pepc=pd.concat([ss_pepc_r1,ss_pepc_r2], axis=1).mean(axis=1)
ss_pepc_err=pd.concat([ss_pepc_r1,ss_pepc_r2], axis=1).std(axis=1)
...
ax.plot(time_pepc,(pepc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
ax.plot(time_sopc,(sopc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10),color='tab:blue', label='AT1R/-/- (SOPC)')
plt.fill_between(time_pepc, (pepc[['TM1-TM6']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM1-TM6']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM1-TM6']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM1-TM6']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
...
ax1.plot(time_pepc,(pepc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
ax1.plot(time_sopc,(sopc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10),color='tab:blue', label='AT1R/-/- (SOPC)')
plt.fill_between(time_pepc, (pepc[['TM1-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM1-ICL2']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM1-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM1-ICL2']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
...
ax2.plot(time_pepc,(pepc[['TM5-ICL2']].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
ax2.plot(time_sopc,(sopc[['TM5-ICL2']].mean(axis=1).rolling(window).mean()*10),color='tab:blue', label='AT1R/-/- (SOPC)')
plt.fill_between(time_pepc, (pepc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM5-ICL2']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM5-ICL2']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
...
ax3.plot(time_pepc,(pepc[['TM6-H8']].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
ax3.plot(time_sopc,(sopc[['TM6-H8']].mean(axis=1).rolling(window).mean()*10),color='tab:blue', label='AT1R/-/- (SOPC)')
plt.fill_between(time_pepc, (pepc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM6-H8']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM6-H8']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
...
ax6.plot(time_pepc,(pepc[['TM3-TM6-ASP241']].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
ax6.plot(time_sopc,(sopc[['TM3-TM6-ASP241']].mean(axis=1).rolling(window).mean()*10),color='tab:blue', label='AT1R/-/- (SOPC)')
plt.fill_between(time_pepc, (pepc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM3-TM6-ASP241']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM3-TM6-ASP241']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
...
ax7.plot(time_ss_sopc,sopc_ss.rolling(500).mean(), color='tab:blue', label='SOPC', rasterized=True)
ax7.plot(time_ss_pepc,ss_pepc.rolling(500).mean(), color='tab:green',label='SOPC:SOPE', rasterized=True)
plt.fill_between(time_ss_pepc, ss_pepc+ss_pepc_err, ss_pepc-ss_pepc_err, color='tab:green', alpha=0.1)
plt.fill_between(time_ss_sopc, sopc_ss+sopc_ss_err, sopc_ss-sopc_ss_err, color='tab:blue', alpha=0.1)
