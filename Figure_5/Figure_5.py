...
ang_r2= pd.read_csv('data_Figure_5/angii/replica_2/Deer_analysis2us', delim_whitespace=True)
...
ang_r1= pd.read_csv('data_Figure_5/angii/replica_1/Deer_analysis2us', delim_whitespace=True)
...
s1i8_r1= pd.read_csv('data_Figure_5/s1i8/replica_1/Deer_analysis2us', delim_whitespace=True)
...
s1i8_r2= pd.read_csv('data_Figure_5/s1i8/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
n_r1= pd.read_csv('data_Figure_5/nanobody/replica_1/Deer_analysis2us', delim_whitespace=True)
...
n_r2= pd.read_csv('data_Figure_5/nanobody/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
an_r1= pd.read_csv('data_Figure_5/agonist_nanobody/replica_1/Deer_analysis2us', delim_whitespace=True)
...
an_r2= pd.read_csv('data_Figure_5/agonist_nanobody/replica_2/Deer_analysis2us', delim_whitespace=True)
...
ang_ssr1=pd.read_csv('data_Figure_5/angii/replica_1/ICL2.xvg', delim_whitespace=True, comment='#')
ang_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Fiv_Helix','Th_Helix']
ang_ssr1=ang_ssr1[:400000]

ang_ssr2=pd.read_csv('data_Figure_5/angii/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
an_ssr1= pd.read_csv('data_Figure_5/agonist_nanobody/replica_1/ICL2.xvg', delim_whitespace=True, comment='#')
an_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']
an_ssr1=an_ssr1[:400000]

an_ssr2= pd.read_csv('data_Figure_5/agonist_nanobody/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
n_ssr1= pd.read_csv('data_Figure_5/nanobody/replica_1/ICL2.xvg', delim_whitespace=True, comment='#')
n_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']
n_ssr1=n_ssr1[:400000]

n_ssr2= pd.read_csv('data_Figure_5/nanobody/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
s1i8_ssr1= pd.read_csv('data_Figure_5/s1i8/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
s1i8_ssr2= pd.read_csv('data_Figure_5/s1i8/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
