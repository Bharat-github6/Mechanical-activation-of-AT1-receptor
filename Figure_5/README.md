...
**Figure 5:** ```Figure_5.py``` time evolution of agonist (replica 1) and/or nanobody bound systems as well as the average interhelical distances of last 500nd (box plot).<br> 
