...
ax.plot(time_apo, sopc_apo[['TM1-TM6']].rolling(window).mean()*10, color='tab:blue', label="SOPC-Apo")
ax.plot(time_10, sopc_10[['TM1-TM6']].rolling(window).mean()*10, color='tab:green', label="SOPC + $\gamma$=10 mN/m")
...
leg=ax.legend(ncol=3, frameon=False, borderpad=None, loc='upper center', bbox_to_anchor=(2,1.265), markerscale=8 ,columnspacing=1, handletextpad=0.5, handlelength=1.5, fontsize=12)
...
ax3.set_xlim(0,20)
ax3.set_ylim(10,30)
ax3.set_xlabel('Time  ($\mu$s)', fontsize=12)
...
ax4.set_xlim(-0,20)
ax4.set_ylim(8,23)
ax4.set_xlabel('Time  ($\mu$s)', fontsize=12)
...
ax5.set_ylabel('TYR215(OH)-TYR302(OH) ($\AA$)', fontsize=12)
ax5.set_xlim(0,20)
#plt.ylim(-0.05,1)
ax5.set_xlabel('Time  ($\mu$s)', fontsize=12)
...
ax.text(-0.24, 1., 'a', transform=ax.transAxes, ha='center', fontsize=14, fontweight='bold')
ax1.text(-0.24, 1., 'b', transform=ax1.transAxes, ha='center', fontsize=14, fontweight='bold')
ax2.text(-0.24, 1., 'c', transform=ax2.transAxes, ha='center', fontsize=14, fontweight='bold')
ax3.text(-0.24, 1.05, 'd', transform=ax3.transAxes, ha='center', fontsize=14, fontweight='bold')
ax4.text(-0.24, 1.05, 'e', transform=ax4.transAxes, ha='center', fontsize=14, fontweight='bold')
ax5.text(-0.24, 1.05, 'f', transform=ax5.transAxes, ha='center', fontsize=14, fontweight='bold')


fig = plt.gcf()

plt.subplots_adjust(top=0.92, bottom=0.115, left=0.07, right=0.975, hspace=0.35, wspace=0.35)
