...
a_a = loadtxt('data_Figure_7/s1i8/fes_TM1TM6_TM6H8_reweight.dat')
a_d=  loadtxt('data_Figure_7/s1i8/fes_TM1ICL2_TM5ICL2_reweight.dat')



#APo with ST 10
p_a10 = loadtxt('data_Figure_7/ST_10/fes_TM1TM6_TM6H8_reweight.dat')
p_d10 = loadtxt('data_Figure_7/ST_10/fes_TM1ICL2_TM5ICL2_reweight.dat')
#APO
p_a1 = loadtxt('data_Figure_7/with_protein_only/fes_TM1TM6_TM6H8_reweight.dat')
p_d1 = loadtxt('data_Figure_7/with_protein_only/fes_TM1ICL2_TM5ICL2_reweight.dat')

##ANGii
ang_a = loadtxt('data_Figure_7/angii/fes_TM1TM6_TM6H8_reweight.dat')
ang_d = loadtxt('data_Figure_7/angii/fes_TM1ICL2_TM5ICL2_reweight.dat')

#popc

popc_a = loadtxt('data_Figure_7/popc/fes_TM1TM6_TM6H8_reweight.dat')
popc_d = loadtxt('data_Figure_7/popc/fes_TM1ICL2_TM5ICL2_reweight.dat')

pepc_a=loadtxt('data_Figure_7/SOPC_SOPE/fes_TM1TM6_TM6H8_reweight.dat')
pepc_d=loadtxt('data_Figure_7/SOPC_SOPE/fes_TM1ICL2_TM5ICL2_reweight.dat')
...
for i,data in enumerate((p_a1,p_d1,p_a10,p_d10,ang_a,ang_d,pepc_a,pepc_d,a_a,a_d,popc_a,popc_d,)):
   ...
   # ax.set_ylabel(r'$r$ (nm)',labelpad=1)
    if i == 0:
        ...
        cb.ax.tick_params(length=7, width=0.8,pad=0.8)
...
fig = plt.gcf()
#plt.subplot
plt.subplots_adjust(top=0.92, bottom=0.1, left=0.07, right=0.975, hspace=0.40, wspace=0.50)
