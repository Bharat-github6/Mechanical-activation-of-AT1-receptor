...
pepc_ssr1=pd.read_csv('data/pepc_ICL2_r1.xvg', delim_whitespace=True, comment='#')
pepc_ssr1.columns=['time', 'structure', 'coil','Bend','Turn', 'A_Helix','fiv_Helix','Th_Helix']
...
pepc_ssr1=pepc_ssr1[['A_Helix','fiv_Helix','Th_Helix' ]].sum(axis=1)/11
pepc_ssr2=pepc_ssr2[['A_Helix','fiv_helix','Th_Helix' ]].sum(axis=1)/11
pepc_ss=pd.concat([pepc_ssr1, pepc_ssr2], axis=1).mean(axis=1)
...
st10_ss=pd.concat([st10_ssr1, st10_ssr2], axis=1).mean(axis=1)
...
ax.plot(time_popc,(popc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='POPC')
ax.plot(time_sopc,(sopc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10), color='tab:blue', label='SOPC')
ax.plot(time_pepc,(pepc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10),color='tab:red', label='SOPE:SOPC') 
ax.plot(time_st10,(st10[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10), color='grey', label='SOPC +  10mN/m')
#plt.fill_between(time_pepc, (pepc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM1-TM6']].std(axis=1).rolling(window).mean()*10), (pepc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM1-TM6']].std(axis=1).rolling(window).mean()*10),color='tab:red', alpha=0.1)
#plt.fill_between(time_popc, (popc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)-(popc[['TM1-TM6']].std(axis=1).rolling(window).mean()*10), (popc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)+(popc[['TM1-TM6']].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
#plt.fill_between(time_sopc, (sopc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)-(sopc[['TM1-TM6']].std(axis=1).rolling(window).mean()*10), (sopc[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)+(sopc[['TM1-TM6']].std(axis=1).rolling(window).mean()*10),color='tab:blue', alpha=0.1)
#plt.fill_between(time_st10, (st10[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)-(st10[['TM1-TM6']].std(axis=1).rolling(window).mean()*10), (st10[['TM1-TM6']].mean(axis=1).rolling(window).mean()*10)+(st10[['TM1-TM6']].std(axis=1).rolling(window).mean()*10),color='grey', alpha=0.1)
...
ax1.plot(time_popc,(popc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax1.plot(time_pepc,(pepc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax1.plot(time_sopc,(sopc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax1.plot(time_st10,(st10[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
#plt.fill_between(time_pepc, (pepc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10), (pepc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10),color='tab:red', alpha=0.1)
#plt.fill_between(time_popc, (popc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)-(popc[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10), (popc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)+(popc[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
#plt.fill_between(time_sopc, (sopc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)-(sopc[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10), (sopc[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)+(sopc[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10),color='tab:blue', alpha=0.1)
#plt.fill_between(time_st10, (st10[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)-(st10[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10), (st10[['TM1-ICL2']].mean(axis=1).rolling(window).mean()*10)+(st10[['TM1-ICL2']].std(axis=1).rolling(window).mean()*10),color='grey', alpha=0.1)
...
ax2.plot(time_pepc,(pepc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax2.plot(time_sopc,(sopc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax2.plot(time_st10,(st10[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
#plt.fill_between(time_pepc, (pepc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM5-ICL2']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM5-ICL2']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:red', alpha=0.1)
...
#plt.fill_between(time_st10, (st10[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)-(st10[['TM5-ICL2']][:200000].std(axis=1).rolling(window).mean()*10), (st10[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10)+(st10[['TM5-ICL2']][:200000].std(axis=1).rolling(window).mean()*10),color='grey', alpha=0.1)
...
ax3.plot(time_pepc,(pepc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax3.plot(time_sopc,(sopc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax3.plot(time_st10,(st10[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
#plt.fill_between(time_pepc, (pepc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM6-H8']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM6-H8']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:red', alpha=0.1)
...
#plt.fill_between(time_st10, (st10[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10)-(st10[['TM6-H8']][:200000].std(axis=1).rolling(window).mean()*10), (st10[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10)+(st10[['TM6-H8']][:200000].std(axis=1).rolling(window).mean()*10),color='grey', alpha=0.1)
...
ax4.plot(time_popc,(popc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax4.plot(time_pepc,(pepc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax4.plot(time_sopc,(sopc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax4.plot(time_st10,(st10[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
#plt.fill_between(time_pepc, (pepc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['TM3-TM6-ASP241']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['TM3-TM6-ASP241']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:red', alpha=0.1)
...
#plt.fill_between(time_st10, (st10[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10)-(st10[['TM3-TM6-ASP241']][:200000].std(axis=1).rolling(window).mean()*10), (st10[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10)+(st10[['TM3-TM6-ASP241']][:200000].std(axis=1).rolling(window).mean()*10),color='grey', alpha=0.1)
...
ax6.plot(time,popc_ss.rolling(window).mean(),color='tab:green',label='AT1R/-/- (POPC)')
ax6.plot(time,pepc_ss.rolling(window).mean(),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax6.plot(time,sopc_ss.rolling(window).mean(), color='tab:blue', label='AT1R/-/- (SOPC)')
ax6.plot(time,st10_ss.rolling(window).mean(), color='grey', label='AT1R/-/- (ST10)')
#plt.fill_between(time_pepc, (pepc[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)-(pepc[['OH']][:200000].std(axis=1).rolling(window).mean()*10), (pepc[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)+(pepc[['OH']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:red', alpha=0.1)
#plt.fill_between(time_popc, (popc[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)-(popc[['OH']][:200000].std(axis=1).rolling(window).mean()*10), (popc[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)+(popc[['OH']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:green', alpha=0.1)
#plt.fill_between(time_sopc, (sopc[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)-(sopc[['OH']][:200000].std(axis=1).rolling(window).mean()*10), (sopc[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)+(sopc[['OH']][:200000].std(axis=1).rolling(window).mean()*10),color='tab:blue', alpha=0.1)
#plt.fill_between(time_st10, (st10[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)-(st10[['OH']][:200000].std(axis=1).rolling(window).mean()*10), (st10[['OH']][:200000].mean(axis=1).rolling(window).mean()*10)+(st10[['OH']][:200000].std(axis=1).rolling(window).mean()*10),color='grey', alpha=0.1)
...
fig = plt.gcf()
plt.subplots_adjust(top=0.9, bottom=0.115, left=0.1, right=0.975, hspace=0.43, wspace=0.5)
plt.Figure.set_size_inches(fig,(8, 4))
