...
popc=np.loadtxt('rmsd_data/popc.dat')
st10=np.loadtxt('rmsd_data/st10.dat')
angii=np.loadtxt('rmsd_data/angii.dat')
apo=np.loadtxt('rmsd_data/sopc_apo.dat')
partial_ag=np.loadtxt('rmsd_data/s1i8.dat')
pe=np.loadtxt('rmsd_data/sopc_sope.dat')
