...
sopc_r1=pd.read_csv('data_Supp_figure_3/sopc_r1', delim_whitespace=True)
sopc_r1.columns=['time','TYR', 'OH', 'n', 'n']
sopc_r1=sopc_r1[['time','TYR', 'OH']]
sopc_r1=sopc_r1[:200000]
time_sopc=np.linspace(0,2000,len(sopc_r1))

sopc_r2=pd.read_csv('data_Supp_figure_3/sopc_r2', delim_whitespace=True)
...
popc_r1=pd.read_csv('data_Supp_figure_3/popc_r1', delim_whitespace=True)
...
popc_r2=pd.read_csv('data_Supp_figure_3/popc_r2', delim_whitespace=True)
...
dmpc_r1=pd.read_csv('data_Supp_figure_3/dmpc_r1', delim_whitespace=True)
...
dmpc_r2=pd.read_csv('data_Supp_figure_3/dmpc_r2', delim_whitespace=True)
...
st5_r2=pd.read_csv('data_Supp_figure_3/st5_r1', delim_whitespace=True)
st5_r2.columns=['time','TYR', 'OH', 'n', 'n']
st5_r2=st5_r2[['time','TYR', 'OH']]
st5_r2=st5_r2[:197500]
window=1

st5_r1=pd.read_csv('data_Supp_figure_3/st5_r2', delim_whitespace=True)
...
st10_r1=pd.read_csv('data_Supp_figure_3/st10_r1', delim_whitespace=True)
...
st10_r2=pd.read_csv('data_Supp_figure_3/st10_r2', delim_whitespace=True)
...
st15_r1=pd.read_csv('data_Supp_figure_3/st15_r1', delim_whitespace=True)
...
st15_r2=pd.read_csv('data_Supp_figure_3/st15_r2', delim_whitespace=True)
...
st20_r1=pd.read_csv('data_Supp_figure_3/st20_r1', delim_whitespace=True)
...
st20_r2=pd.read_csv('data_Supp_figure_3/st20_r2', delim_whitespace=True)
...
ang_r1= pd.read_csv('data_Supp_figure_3/angii_r1', delim_whitespace=True)
ang_r1.columns=['time','TYR', 'OH', 'n', 'n']
ang_r1=ang_r1[['time','TYR', 'OH']]
ang_r1=ang_r1[:200000]


ang_r2= pd.read_csv('data_Supp_figure_3/angii_r2', delim_whitespace=True)
...
an_r1= pd.read_csv('data_Supp_figure_3/an_r1', delim_whitespace=True)
an_r1.columns=['time','TYR', 'OH', 'n', 'n']
an_r1=an_r1[['time','TYR', 'OH']]
an_r1=an_r1[:197500]


an_r2= pd.read_csv('data_Supp_figure_3/an_r2', delim_whitespace=True)
...
pepc_r1= pd.read_csv('data_Supp_figure_3/pepc_r1', delim_whitespace=True)
pepc_r1.columns=['time','TYR', 'OH', 'n', 'n']
pepc_r1=pepc_r1[['time','TYR', 'OH']]
pepc_r1=pepc_r1[:200000]

pepc_r2= pd.read_csv('data_Supp_figure_3/pepc_r2', delim_whitespace=True)
...
n_r1= pd.read_csv('data_Supp_figure_3/n_r1', delim_whitespace=True)
n_r1.columns=['time','TYR', 'OH', 'n', 'n']
n_r1=n_r1[['time','TYR', 'OH']]
n_r1=n_r1[:197500]


n_r2= pd.read_csv('data_Supp_figure_3/n_r2', delim_whitespace=True)
...
s1i8_r1= pd.read_csv('data_Supp_figure_3/s1i8_r1', delim_whitespace=True)
s1i8_r1.columns=['time','TYR', 'OH', 'n', 'n']
s1i8_r1=s1i8_r1[['time','TYR', 'OH']]
s1i8_r1=s1i8_r1[:197500]


s1i8_r2= pd.read_csv('data_Supp_figure_3/s1i8_r2', delim_whitespace=True)
