...
popc_st5= pd.read_csv('data/popc_st5', delim_whitespace=True)
...
npxxy_st5= pd.read_csv('data/npxxy_st5', delim_whitespace=True)
npxxy_st5.columns=['time','TYR', 'OH', 'n', 'n']


popc_st10= pd.read_csv('data/popc_st10', delim_whitespace=True)
...
npxxy_st10= pd.read_csv('data/npxxy_st10', delim_whitespace=True)
npxxy_st10.columns=['time','TYR', 'OH', 'n', 'n']



st5_icl2= pd.read_csv('data/popc_st5_ICL2.xvg', delim_whitespace=True, comment='#')
st5_icl2.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']

st10_icl2= pd.read_csv('data/popc_st10_ICL2.xvg', delim_whitespace=True, comment='#')
...
sopc_r1=pd.read_csv('data/sopc_npxxy_r1', delim_whitespace=True)
sopc_r1.columns=['time','TYR', 'OH', 'n', 'n']
sopc_r1=sopc_r1[['time','TYR', 'OH']]
sopc_r1=sopc_r1[:200000]
#time_sopc=np.linspace(0,2000,len(sopc_r1))

sopc_r2=pd.read_csv('data/sopc_npxxy_r2', delim_whitespace=True)
...
time_sopc_npxxy=np.linspace(0,2000,len(sopc_npxxy))


popc_r1=pd.read_csv('data/popc_npxxy_r1', delim_whitespace=True)
...
popc_r2=pd.read_csv('data/popc_npxxy_r2', delim_whitespace=True)
...
ax.plot(time_popc,(popc[['TM1-TM6']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='POPC + 0mN/m')
ax.plot(time_sopc,(sopc[['TM1-TM6']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:blue',label='SOPC + 0mN/m')
...
plt.plot(time_popc,(popc[['TM1-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='POPC + 0mN/m')
plt.plot(time_sopc,(sopc[['TM1-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:blue',label='SOPC + 0mN/m')
...
plt.plot(time_popc,(popc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='POPC + 0mN/m')
plt.plot(time_sopc,(sopc[['TM5-ICL2']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:blue',label='SOPC + 0mN/m')
...
plt.plot(time_popc,(popc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='POPC + 0mN/m')
plt.plot(time_sopc,(sopc[['TM6-H8']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:blue',label='SOPC + 0mN/m')
...
plt.plot(time_popc,(popc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:green',label='POPC + 0mN/m')
plt.plot(time_sopc,(sopc[['TM3-TM6-ASP241']][:200000].mean(axis=1).rolling(window).mean()*10),color='tab:blue',label='SOPC + 0mN/m')
...
plt.plot(time_popc_npxxy, popc_npxxy.rolling(window).mean(), color='tab:green', label='POPC + 0mN/m')
plt.plot(time_sopc_npxxy, sopc_npxxy.rolling(window).mean(), color='tab:blue', label='SOPC + 0mN/m')
...
plt.plot(st5_icl2[['time']]*0.001,st5_icl2[['A_Helix']].rolling(500).mean()*0.09,color='grey', label='POPC + 5mN/m' )
plt.plot(time_st10icl2,st10_icl2.rolling(500).mean(),color='tab:red', label='POPC + 10mN/m')
plt.plot(time_ss_popc, popc_ss.rolling(window).mean(), color='tab:green', label='POPC + 0mN/m')
plt.plot(time_ss_sopc, sopc_ss.rolling(window).mean(), color='tab:blue', label='SOPC + 0mN/m')
plt.xlim(0,2000)
