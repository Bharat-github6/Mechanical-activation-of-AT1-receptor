...
sopc_r1= pd.read_csv('data_Supp_figure_6/SOPC/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
sopc_r2= pd.read_csv('data_Supp_figure_6/SOPC/replica_2/Deer_analysis2us', delim_whitespace=True)
...
pepc_r1= pd.read_csv('data_Supp_figure_6/PE_PC/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
pepc_r2= pd.read_csv('data_Supp_figure_6/PE_PC/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
pepc_r1_1us= pd.read_csv('data_Supp_figure_6/PE_PC/replica_1/ICL2_1us.xvg', delim_whitespace=True, comment='#')
pepc_r1_1us.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']

pepc_r1_2us= pd.read_csv('data_Supp_figure_6/PE_PC/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
ss_pepc_r2= pd.read_csv('data_Supp_figure_6/PE_PC/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
sopc_ssr1=pd.read_csv('data_Supp_figure_6/SOPC/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
sopc_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Fiv_Helix','Th_Helix']

sopc_ssr2=pd.read_csv('data_Supp_figure_6/SOPC/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
ax.plot(time_pepc,(pepc_r2[['TM1-TM6']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
...
ax1.plot(time_pepc,(pepc_r2[['TM1-ICL2']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
...
ax2.plot(time_pepc,(pepc_r2[['TM5-ICL2']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
...
ax3.plot(time_pepc,(pepc_r2[['TM6-H8']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
...
ax6.plot(time_pepc,(pepc_r2[['TM3-TM6-ASP241']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (SOPC-SOPE)')
...
ax7.plot(time_ss_sopc,sopc_ssr2[:400000].rolling(500).mean(), color='tab:blue', label='SOPC', rasterized=True)
ax7.plot(time_ss_pepc,ss_pepc_r2[:400000].rolling(500).mean(), color='tab:green',label='SOPC:SOPE', rasterized=True)
...
plt.subplots_adjust(top=0.90, bottom=0.115, left=0.08, right=0.95, hspace=0.43, wspace=0.65)
plt.Figure.set_size_inches(fig,(10, 4.2))

plt.savefig('Supp_figure_6.png' ,dpi=600) ## block=False, agg_filter=None)
