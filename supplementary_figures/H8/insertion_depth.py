...
st10_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/SOPC/with_protein_only/ASPH74-125/surface_tension/starting_from_active_structure/st_after_posres/st_10/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
st10_r1.columns=['time', 'X','Y','Z']
st10_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/SOPC/with_protein_only/ASPH74-125/surface_tension/starting_from_active_structure/st_after_posres/st_10_r2/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
...
####
pepc_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/SOPC/with_protein_only/ASPH74-125/SOPC_SOPE/replica_1/descriptor/H8-zdepth.xvg', delim_whitespace=True)
pepc_r1.columns=['time', 'X','Y','Z']
pepc_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/SOPC/with_protein_only/ASPH74-125/SOPC_SOPE/replica_2/descriptor/H8-zdepth.xvg', delim_whitespace=True)
...
####
sopc_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/SOPC/with_protein_only/ASPH74-125/replica_2/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
sopc_r1.columns=['time', 'X','Y','Z']
sopc_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/SOPC/with_protein_only/ASPH74-125/production_run/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
...
###
popc_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/POPC/with_protein_only/ASPH74-125/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
popc_r1.columns=['time', 'X','Y','Z']
popc_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/POPC/with_protein_only/replica_2/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
...
popcmut_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_1/POPC/descriptor/H8-zdepth.xvg', delim_whitespace=True)
popcmut_r1.columns=['time', 'X','Y','Z']

popcmut_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_2/POPC/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
...
sopcmut_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_1/SOPC/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
sopcmut_r1.columns=['time', 'X','Y','Z']

sopcmut_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_2/SOPC/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
...
st10mut_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_1/ST_10/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
st10mut_r1.columns=['time', 'X','Y','Z']

st10mut_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_2/ST_10/descriptor/H8-zdepth_1.xvg', delim_whitespace=True)
...
pepcmut_r1=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_1/SOPC_SOPE/descriptor/H8-zdepth.xvg', delim_whitespace=True)
pepcmut_r1.columns=['time', 'X','Y','Z']

pepcmut_r2=pd.read_csv('/home/bpoudel/projects/gpcr/6do1-active-state/H8/correct_one/replica_2/SOPC_SOPE/descriptor/H8-zdepth.xvg', delim_whitespace=True)
...
plt.savefig('H8-Zdepth.png', dpi=300)
