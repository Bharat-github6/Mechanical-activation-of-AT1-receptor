...
apo_ss=pd.read_csv('data_Supp_figure_14/ICL2_apo.xvg', delim_whitespace=True, comment='#')
...
angii_ss=pd.read_csv('data_Supp_figure_14/ICL2_angii.xvg', delim_whitespace=True, comment='#')
...
st10_ss=pd.read_csv('data_Supp_figure_14/ICL2_st10.xvg', delim_whitespace=True, comment='#')
...
plt.legend(loc='best')
#plt.close()
plt.savefig('Supp_figure_14.png', dpi=600)
plt.close()
