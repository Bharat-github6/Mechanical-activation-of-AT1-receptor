...
ax.plot(time_popc,(popc_r2[['TM1-TM6']][:200000].rolling(window).mean()*10),color='tab:green',label='POPC')
ax.plot(time_sopc,(sopc_r2[['TM1-TM6']][:200000].rolling(window).mean()*10), color='tab:blue', label='SOPC')
ax.plot(time_pepc,(pepc_r2[['TM1-TM6']][:200000].rolling(window).mean()*10),color='tab:red', label='SOPE:SOPC') 
ax.plot(time_st10,(st10_r2[['TM1-TM6']][:200000].rolling(window).mean()*10), color='grey', label='SOPC + 10 mN/m')
...
ax1.plot(time_pepc,(pepc_r2[['TM1-ICL2']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax1.plot(time_sopc,(sopc_r2[['TM1-ICL2']][:200000].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax1.plot(time_st10,(st10_r2[['TM1-ICL2']][:200000].rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
...
ax2.plot(time_pepc,(pepc_r2[['TM5-ICL2']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax2.plot(time_sopc,(sopc_r2[['TM5-ICL2']][:200000].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax2.plot(time_st10,(st10_r2[['TM5-ICL2']][:200000].rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
...
ax3.plot(time_pepc,(pepc_r2[['TM6-H8']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax3.plot(time_sopc,(sopc_r2[['TM6-H8']][:200000].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax3.plot(time_st10,(st10_r2[['TM6-H8']][:200000].rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
...
ax4.plot(time_popc,(popc_r2[['TM3-TM6-ASP241']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax4.plot(time_pepc,(pepc_r2[['TM3-TM6-ASP241']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax4.plot(time_sopc,(sopc_r2[['TM3-TM6-ASP241']][:200000].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax4.plot(time_st10,(st10_r2[['TM3-TM6-ASP241']][:200000].rolling(window).mean()*10), color='grey', label='AT1R/-/- (ST10)')
...
ax6.plot(time,popc_ssr2.rolling(window).mean(),color='tab:green',label='AT1R/-/- (POPC)')
ax6.plot(time_pepc_ss[:len(pepc_ssr2)],pepc_ssr2.rolling(window).mean(),color='tab:red', label='AT1R/-/- (SOPE_SOPC)')
ax6.plot(time,sopc_ssr2.rolling(window).mean(), color='tab:blue', label='AT1R/-/- (SOPC)')
ax6.plot(time,st10_ssr2.rolling(window).mean(), color='grey', label='AT1R/-/- (ST10)')
...
plt.savefig('Supp_figure_8.png', dpi=300)
