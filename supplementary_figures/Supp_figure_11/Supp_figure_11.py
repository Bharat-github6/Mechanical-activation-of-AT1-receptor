...
ang_r2= pd.read_csv('data_Supp_figure_11/angii/replica_2/Deer_analysis2us', delim_whitespace=True)
...
ang_r1= pd.read_csv('data_Supp_figure_11/angii/replica_1/Deer_analysis2us', delim_whitespace=True)
...
s1i8_r1= pd.read_csv('data_Supp_figure_11/s1i8/replica_1/Deer_analysis2us', delim_whitespace=True)
...
s1i8_r2= pd.read_csv('data_Supp_figure_11/s1i8/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
n_r1= pd.read_csv('data_Supp_figure_11/nanobody/replica_1/Deer_analysis2us', delim_whitespace=True)
...
n_r2= pd.read_csv('data_Supp_figure_11/nanobody/replica_2/Deer_analysis_2us', delim_whitespace=True)
...
an_r1= pd.read_csv('data_Supp_figure_11/agonist_nanobody/replica_1/Deer_analysis2us', delim_whitespace=True)
...
an_r2= pd.read_csv('data_Supp_figure_11/agonist_nanobody/replica_2/Deer_analysis2us', delim_whitespace=True)
...
ang_ssr1=pd.read_csv('data_Supp_figure_11/angii/replica_1/ICL2.xvg', delim_whitespace=True, comment='#')
ang_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Fiv_Helix','Th_Helix']
ang_ssr1=ang_ssr1[:400000]

ang_ssr2=pd.read_csv('data_Supp_figure_11/angii/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
an_ssr1= pd.read_csv('data_Supp_figure_11/agonist_nanobody/replica_1/ICL2.xvg', delim_whitespace=True, comment='#')
an_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']
an_ssr1=an_ssr1[:400000]

an_ssr2= pd.read_csv('data_Supp_figure_11/agonist_nanobody/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
n_ssr1= pd.read_csv('data_Supp_figure_11/nanobody/replica_1/ICL2.xvg', delim_whitespace=True, comment='#')
n_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']
n_ssr1=n_ssr1[:400000]

n_ssr2= pd.read_csv('data_Supp_figure_11/nanobody/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
s1i8_ssr1= pd.read_csv('data_Supp_figure_11/s1i8/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
s1i8_ssr2= pd.read_csv('data_Supp_figure_11/s1i8/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
time_ang=np.linspace(0,2000,len(ang_r2[['TM1-TM6']]))
time_s1i8=np.linspace(0,2000,len(s1i8_r2[['TM1-TM6']]))
time_n=np.linspace(0,2000,len(n_r2[['TM1-TM6']]))
time_an=np.linspace(0,2000,len(an_r2[['TM1-TM6']]))


time_ang_ss=np.linspace(0,2000,len(ang_ssr2))
time_s1i8_ss=np.linspace(0,2000,len(s1i8_ssr2))
time_n_ss=np.linspace(0,2000,len(n_ssr2))
time_an_ss=np.linspace(0,2000,len(an_ssr2))
...
ax.plot(time_ang,(ang_r2[['TM1-TM6']].rolling(window).mean()*10),color='tab:blue',label='AT1R + AngII')
ax.plot(time_s1i8,(s1i8_r2[['TM1-TM6']].rolling(window).mean()*10),color='tab:red', label='AT1R + S1i8')
ax.plot(time_an,(an_r2[['TM1-TM6']].rolling(window).mean()*10), color='tab:green', label='AT1R + S1I8 + Nanobody')
ax.plot(time_n,(n_r2[['TM1-TM6']].rolling(window).mean()*10), color='tab:purple', label='AT1R + Nanobody')
...
ax1.plot(time_ang,(ang_r2[['TM1-ICL2']].rolling(window).mean()*10),color='tab:blue',label='AT1R + AngII')
ax1.plot(time_s1i8,(s1i8_r2[['TM1-ICL2']].rolling(window).mean()*10),color='tab:red', label='AT1R + S1i8')
ax1.plot(time_an,(an_r2[['TM1-ICL2']].rolling(window).mean()*10), color='tab:green', label='AT1R + S1I8 + Nanobody')
ax1.plot(time_n,(n_r2[['TM1-ICL2']].rolling(window).mean()*10), color='tab:purple', label='AT1R + Nanobody')
...
ax2.plot(time_ang,(ang_r2[['TM5-ICL2']].rolling(window).mean()*10),color='tab:blue',label='AT1R + AngII')
ax2.plot(time_s1i8,(s1i8_r2[['TM5-ICL2']].rolling(window).mean()*10),color='tab:red', label='AT1R + S1i8')
ax2.plot(time_an,(an_r2[['TM5-ICL2']].rolling(window).mean()*10), color='tab:green', label='AT1R + S1I8 + Nanobody')
ax2.plot(time_n,(n_r2[['TM5-ICL2']].rolling(window).mean()*10), color='tab:purple', label='AT1R + Nanobody')
ax2.set_xlim(0,2000)
...
ax3.plot(time_ang,(ang_r2[['TM6-H8']].rolling(window).mean()*10),color='tab:blue',label='AT1R + AngII')
ax3.plot(time_s1i8,(s1i8_r2[['TM6-H8']].rolling(window).mean()*10),color='tab:red', label='AT1R + S1i8')
ax3.plot(time_an,(an_r2[['TM6-H8']].rolling(window).mean()*10), color='tab:green', label='AT1R + S1I8 + Nanobody')
ax3.plot(time_n,(n_r2[['TM6-H8']].rolling(window).mean()*10), color='tab:purple', label='AT1R + Nanobody')
...
ax4.plot(time_ang,(ang_r2[['TM3-TM6-ASP241']].rolling(window).mean()*10),color='tab:blue',label='AT1R + AngII')
ax4.plot(time_s1i8,(s1i8_r2[['TM3-TM6-ASP241']].rolling(window).mean()*10),color='tab:red', label='AT1R + S1i8')
ax4.plot(time_an,(an_r2[['TM3-TM6-ASP241']].rolling(window).mean()*10), color='tab:green', label='AT1R + S1I8 + Nanobody')
ax4.plot(time_n,(n_r2[['TM3-TM6-ASP241']].rolling(window).mean()*10), color='tab:purple', label='AT1R + Nanobody')
...
ax5.plot(time_ang_ss,ang_ssr2.rolling(window).mean(), color='tab:blue', label='SOPC + AngII')
ax5.plot(time_s1i8_ss,s1i8_ssr2.rolling(window).mean(), color='tab:red', label='SOPC + S1I8')
ax5.plot(time_an_ss,an_ssr2.rolling(window).mean(), color='tab:purple', label='SOPC + S1I8 + Nanobody')
ax5.plot(time_n_ss,n_ssr2.rolling(window).mean(), color='tab:green', label='SOPC + Nanobody')
...
plt.subplots_adjust(top=0.90, bottom=0.115, left=0.08, right=0.92, hspace=0.43, wspace=0.7)
...
plt.savefig('Supp_figure_11.png', dpi=300)
