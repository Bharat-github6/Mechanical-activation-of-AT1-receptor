...
popc=np.loadtxt('data_Supp_figure_12/rmsd_data/popc.dat')
st10=np.loadtxt('data_Supp_figure_12/rmsd_data/st10.dat')
angii=np.loadtxt('data_Supp_figure_12/rmsd_data/angii.dat')
apo=np.loadtxt('data_Supp_figure_12/rmsd_data/sopc_apo.dat')
partial_ag=np.loadtxt('data_Supp_figure_12/rmsd_data/s1i8.dat')
pe=np.loadtxt('data_Supp_figure_12/rmsd_data/sopc_sope.dat')
...
plt.savefig('Supp_figure_12.png', bbox_inches='tight', dpi=300)
