...
sopc_apo=pd.read_csv('data_Supp_figure_2/sopc_apo', delim_whitespace=True)
sopc_apo.columns=['time', 'TM1-TM6', 'TM1-ICL2', 'TM5-ICL2', 'TM6-H8', 'n', 'n']

popc_apo=pd.read_csv('data_Supp_figure_2/popc_apo', delim_whitespace=True)
...
sopc_apo_anton=pd.read_csv('data_Supp_figure_2/sopc_apo_anton', delim_whitespace=True)
...
plt.plot(time_sopc, sopc_apo[['TM1-TM6']].rolling(20).mean()*10, color='tab:blue', label='Apo AT1R in SOPC')
...
sopc_ang=pd.read_csv('data_Supp_figure_2/sopc_ang', delim_whitespace=True)
sopc_ang.columns=['time', 'TM1-TM6', 'TM1-ICL2', 'TM5-ICL2', 'TM6-H8', 'n', 'n']


sopc_st15=pd.read_csv('data_Supp_figure_2/sopc_st15', delim_whitespace=True)
...
plt.savefig('Supp_figure_2.png', dpi=900)
