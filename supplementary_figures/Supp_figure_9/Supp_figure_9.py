...
sopc_r1=pd.read_csv('data_Supp_figure_9/sopc_r1', delim_whitespace=True)
sopc_r1.columns=['time','TYR', 'OH', 'n', 'n']
sopc_r1=sopc_r1[['time','TYR', 'OH']]
sopc_r1=sopc_r1[:200000]
time_sopc=np.linspace(0,2000,len(sopc_r1))

sopc_r2=pd.read_csv('data_Supp_figure_9/sopc_r2', delim_whitespace=True)
...
popc_r1=pd.read_csv('data_Supp_figure_9/popc_r1', delim_whitespace=True)
...
popc_r2=pd.read_csv('data_Supp_figure_9/popc_r2', delim_whitespace=True)
...
st10_r1=pd.read_csv('data_Supp_figure_9/st10_r1', delim_whitespace=True)
...
st10_r2=pd.read_csv('data_Supp_figure_9/st10_r2', delim_whitespace=True)
...
pepc_r1= pd.read_csv('data_Supp_figure_9/pepc_r1', delim_whitespace=True)
pepc_r1.columns=['time','TYR', 'OH', 'n', 'n']
pepc_r1=pepc_r1[['time','TYR', 'OH']]
pepc_r1=pepc_r1[:200000]

pepc_r2= pd.read_csv('data_Supp_figure_9/pepc_r2', delim_whitespace=True)
...
popch8_r1= pd.read_csv('data_Supp_figure_9/popch8_r1', delim_whitespace=True)
popch8_r1.columns=['time', 'TM1-TM6', 'TM1-ICL2', 'TM5-ICL2','TM6-H8','TM3-TM6-ASP241','OH','n','n']
popch8_r1=popch8_r1[['OH']]


popch8_r2= pd.read_csv('data_Supp_figure_9/popch8_r2', delim_whitespace=True)
...
sopch8_r1= pd.read_csv('data_Supp_figure_9/sopch8_r1', delim_whitespace=True)
sopch8_r1.columns=['time', 'TM1-TM6', 'TM1-ICL2', 'TM5-ICL2','TM6-H8','TM3-TM6-ASP241','OH','n','n']
sopch8_r1=sopch8_r1[['OH']]


sopch8_r2= pd.read_csv('data_Supp_figure_9/sopch8_r2', delim_whitespace=True)
...
pepch8_r1= pd.read_csv('data_Supp_figure_9/pepch8_r1', delim_whitespace=True)
pepch8_r1.columns=['time', 'TM1-TM6', 'TM1-ICL2', 'TM5-ICL2','TM6-H8','TM3-TM6-ASP241','OH','n','n']
pepch8_r1=pepch8_r1[['OH']]


pepch8_r2= pd.read_csv('data_Supp_figure_9/pepch8_r2', delim_whitespace=True)
...
st10h8_r1= pd.read_csv('data_Supp_figure_9/st10h8_r1', delim_whitespace=True)
st10h8_r1.columns=['time', 'TM1-TM6', 'TM1-ICL2', 'TM5-ICL2','TM6-H8','TM3-TM6-ASP241','OH','n','n']
st10h8_r1=st10h8_r1[['OH']]


st10h8_r2= pd.read_csv('data_Supp_figure_9/st10h8_r2', delim_whitespace=True)
...
plt.savefig('Supp_figure_9.png', dpi=300)
