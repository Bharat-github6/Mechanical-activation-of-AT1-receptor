...
popc_r1= pd.read_csv('data_Figure_1/POPC/replica_1/Deer_analysis2us', delim_whitespace=True)
...
popc_r2= pd.read_csv('data_Figure_1/POPC/replica_2/Deer_analysis2us', delim_whitespace=True)
...
dmpc_r1= pd.read_csv('data_Figure_1/DMPC/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
dmpc_r2= pd.read_csv('data_Figure_1/DMPC/replica_2/Deer_analysis2us', delim_whitespace=True)
...
sopc_r1= pd.read_csv('data_Figure_1/SOPC/replica_1/Deer_analysis_2us', delim_whitespace=True)
...
sopc_r2= pd.read_csv('data_Figure_1/SOPC/replica_2/Deer_analysis2us', delim_whitespace=True)
...
sopc_ssr1=pd.read_csv('data_Figure_1/SOPC/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
sopc_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Fiv_Helix','Th_Helix']

sopc_ssr2=pd.read_csv('data_Figure_1/SOPC/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
popc_ssr1=pd.read_csv('data_Figure_1/POPC/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
popc_ssr1.columns=['time', 'structure', 'coil', 'Bend', 'Turn', 'A_Helix','Th_Helix']


popc_ssr2=pd.read_csv('data_Figure_1/POPC/replica_2/ICL2.xvg', delim_whitespace=True, comment='#')
...
dmpc_ssr1=pd.read_csv('data_Figure_1/DMPC/replica_1/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
dmpc_ssr2=pd.read_csv('data_Figure_1/DMPC/replica_2/ICL2_2us.xvg', delim_whitespace=True, comment='#')
...
ax.plot(time_popc,(popc_r1[['TM1-TM6']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax.plot(time_dmpc,(dmpc_r1[['TM1-TM6']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
...
ax1.plot(time_dmpc,(dmpc_r1[['TM1-ICL2']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
...
ax2.plot(time_dmpc,(dmpc_r1[['TM5-ICL2']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
...
ax3.plot(time_dmpc,(dmpc_r1[['TM6-H8']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
...
ax6.plot(time_popc,(popc_r1[['TM3-TM6-ASP241']][:200000].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax6.plot(time_dmpc,(dmpc_r1[['TM3-TM6-ASP241']][:200000].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
...
ax7.plot(time_ss_dmpc,dmpc_ssr1[:400000].rolling(window).mean(), color='tab:red', label='DMPC (di-C14:0)')
...
ax7.plot(time_ss_popc,popc_ssr1[:400000].rolling(window).mean(), color='tab:green', label='POPC (C16:0,C18:1)')
...
ax7.plot(time_ss_sopc,sopc_ssr1[:400000].rolling(window).mean(), color='tab:blue', label='SOPC (C18:0,C18:1)')
